...
BASELINE_OPTS=(--iter-recall)
NND_OPTS=(--full-NND --iter-recall)
PROPOSED_OPTS=(--lsh --prefilter --proj-P 8 --lsh-L 4 --lsh-K 2 --lsh-w 64 --lsh-bucket 64 --lsh-cand 48 --pf-mult 2 --iter-recall)
